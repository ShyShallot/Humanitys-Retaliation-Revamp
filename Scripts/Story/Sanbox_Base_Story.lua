...
function BaseStory:Init_Module(Module_Name)
    ...
    if Module_Entry.Module_Reference.Init ~= nil then
        ...
        if Module_Entry.Needs_Plot_File then
            ...
            Module_Entry.Module_Reference:Init(self.Plot_File)
        else
            Module_Entry.Module_Reference:Init()
        end
    ...
    if Module_Entry.Module_Reference.Start ~= nil then
        DebugMessage("%s -- Init_Module: Calling Start method for %s", tostring(Script), tostring(Module_Name))
        if Module_Entry.Needs_Plot_File then
            DebugMessage("%s -- Init_Module: Passing Plot_File to Start", tostring(Script))
            Module_Entry.Module_Reference:Start(self.Plot_File)
        else
            Module_Entry.Module_Reference:Start()
        end

        Module_Entry.Init.Status = true
        DebugMessage("%s -- Init_Module: Module %s successfully started", tostring(Script), tostring(Module_Name))
...
function BaseStory:Update_Module(Module_Name)
    ...
    if Module_Entry.Module_Reference.Check ~= nil then
        ...
        Module_Entry.Module_Reference:Check()
        return
    end
end
